...
func (b *PipelineBuilder) buildETMv4Route(spec sourceRouteSpec) (Route, error) {
	...
	dec, err := etmv4NewDecoder(cfg, mem, instr)
	if err != nil {
		return Route{}, fmt.Errorf("ETMv4 decoder creation failed: %w", err)
	}
