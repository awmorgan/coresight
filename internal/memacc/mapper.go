...
func (m *GlobalMapper) Read(address trace.VAddr, trcID uint8, memSpace trace.MemSpaceAcc, reqBytes uint32, buffer []byte) (uint32, error) {
...
func (m *GlobalMapper) findAccessor(address trace.VAddr, memSpace trace.MemSpaceAcc) (Accessor, bool) {
...
func memSpaceSpecificity(memSpace trace.MemSpaceAcc) int {
